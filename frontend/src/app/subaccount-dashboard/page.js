...
export default function SubaccountDashboard() {
  ...
  return (
    <ProtectedRoute requiredAccountType="subaccount">
              ...
              <div className="flex items-center">
                ...
                <div className="hidden md:block">
                  <div className="ml-10 flex items-baseline space-x-4">
                    ...
                    <Link
                      href="/subaccount-dashboard/posts"
                      className="px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-indigo-500"
                    >
                      Posts
                    </Link>
                    <Link
                      href="/subaccount-dashboard/analytics"
                      className="px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-indigo-500"
                    >
                      Analytics
                    </Link>
                    <Link
                      href="/subaccount-dashboard/settings"
                      className="px-3 py-2 rounded-md text-sm font-medium text-white hover:bg-indigo-500"
                    >
                      Settings
                    </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <button
                onClick={() => toast.info("Contact admin feature coming soon!")}
                className="bg-white hover:bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col items-center shadow-sm"
              >
                <svg
                  className="h-8 w-8 text-indigo-600"
                ...
                <span className="mt-2 text-sm font-medium">Contact Admin</span>
              </button>
            </div>
          </div>
        </div>
